...
"""
    ...
    Writes text labels generated by [`ImageMorphology.label_components`](@ref)
into `img`. Writes one text label per centroid identified by
[`ImageMorphology.component_centroids`](@ref). Ignores the background pixels,
